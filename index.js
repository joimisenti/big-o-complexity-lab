...
// ANSWER:
function improveNumbersSquared(numbers) {
  let squares = [];
  for (let i = 0; i < numbers.length; i++) {
...
// ANSWER: Each function will produce an output that is dependent on the size of the string sent as the input
